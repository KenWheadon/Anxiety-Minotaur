...
const RECRUITMENT_COMPLETE = "RECRUITMENT_COMPLETE";
...
const FEAR_LOW = "fear_low";
const GREED_HIGH = "greed_high";
const GREED_LOW = "greed_low";
const PRIDE_HIGH = "pride_high";
const PRIDE_LOW = "pride_low";
